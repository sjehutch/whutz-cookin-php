        ...
        <div class="row">
           ...
           <div class="col s12 m7 offset-m1 wow fadeIn content-box" style="color:#000;">
				...
				<div class="col m3">
					...
					<div class="profile card"><a href=""><img src="pro_pic/<?php echo $myprofile['pro_pic']; ?>" style="max-width: 180px; max-height: 180px; min-height: 160px; min-width: 160px;"></a></div>
				...
				<div class="col  m9 s12">
					...
					<form action="phpcode1.php" method="POST"  enctype="multipart/form-data">
						...
						<?php  
$qq=mysql_query("SELECT * FROM `c_sms` where (user_id = '$c_id' and to_id = '$user_id') OR (user_id = '$user_id' and to_id = '$c_id') ORDER BY `id` ASC ");
...
?> 					
							...
							<div class="sender pull-left">
									<div class="col m2"><img src="pro_pic/<?php echo $userif['pro_pic']; ?>" class="user" style="max-width: 56px; max-height: 56px; min-height: 56px; min-width: 56px;"></div>
									<div class="col m10">
					...
					<?php } else{ ?>	
							<div class="sender pull-left">
									<div class="col m2"><img src="pro_pic/<?php echo $myprofile['pro_pic']; ?>" class="user" style="max-width: 56px; max-height: 56px; min-height: 56px; min-width: 56px;"></div>
									<div class="col m10">
										<h3 class="left-align msg"><b><?php echo $row['message']; ?></b></h3>
										<p class="left-align time"><?php echo time_ago($row['date']); ?>qqq</p>				
									</div>
							</div>
						<?php } } ?>
						...
						<button type="submit" name="sms" class="btn-large btn-bordered waves-effect waves-light transparent disabled"  >
                            Send
                        </button>
