   ...
   <div class="section white-text center" id="intro">
        <div class="row">
           ...
           <div class="col s12 m9 wow fadeIn content-box" style="color:#000;">
				<h4 class="text-left">MY CALENDAR </h3>
					<hr/>
				<div class="row">
...
<?php
	$aaj = date('Y-m-d');
	$qq = mysql_query("SELECT * FROM `c_booking`  where cook_id = '$user_id' and date >= '$aaj' and payement = '1' and status='Booked' ORDER BY `date` ASC");
...
while($row=mysql_fetch_assoc($qq)){
	?>
		...
		<img src="<?php echo "http://betaonetesting.com/cookin/pro_pic/".$hh['pro_pic']; ?>" class="thumbnail" class="dish-detail-img" style="width:100px;">
