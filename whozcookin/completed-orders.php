  ...
  color: #fff;
   ...
   <div class="section white-text center" id="intro">
        <div class="row">
			...
			<h3 class="text-left">COMPLETED ORDERS</h3>
					<hr/>
				<div class="row">
					<form action="#">
	...
	$unq_code = '';
	$status_code = '';
	$qq=mysql_query("SELECT * FROM `c_checkout`  where delivered ='1' and delivery_user = '$user_id' and date = '$now_date' 
	...
	<?php } else { ?>	
		...
		<input id="input-2c" class="rating" min="0" max="5" step="1" data-size="sm"
           data-symbol="&#xf005;" value="<?php echo $row['rating']; ?>" data-glyphicon="false" data-rating-class="rating-fa" readonly>
<?php } ?>
		</td>
      </tr>
    <?php } ?>
