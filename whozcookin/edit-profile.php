   ...
   <div class="section white-text center" id="intro">
		...
		<form action="phpcode1.php" method="POST"  enctype="multipart/form-data" >
					...
					<div class="btn btn-update">
						...
						<input type="hidden" name="old_photo" value="<?php echo $myprofile['pro_pic']; ?>">
					</div>
					...
					<div class="input-field col s6">
						<input placeholder="Mobile No" name="mobile" value="<?php echo $myprofile['mobile']; ?>" id="mobile-no" type="text" >	
					</div>
					...
					<div class="input-field col s6">
						<input placeholder="Website" name="website" value="<?php echo $myprofile['website']; ?>" id="website" type="text" >
					...
					<div class="input-field col s12">
						...
						<div class="input-field col s6">
							<input placeholder="Specialty" name="specialty" value="<?php echo $myprofile['specialty']; ?>" id="Specialty" type="text" >
							
						</div>
						<input type="hidden" value="<?php echo $user_id; ?>" name="id">
						<div class="input-field col s12">
							<textarea id="textarea1" name="work" class="materialize-textarea" placeholder="Work history">
							<?php echo $myprofile['work']; ?>
							</textarea>
						</div>
						
					<button class="btn btn-fav" type="submit" name="Update">
                            Update
                        </button>
