   ...
   <div class="section white-text center" id="intro">
        <div class="row">
			...
			<div class="col s12 m9 wow fadeIn content-box" style="color:#000;">
				...
				<h4 class="text-left">NEW ORDERS</h3>
					<hr/>
				<div class="row">
					<form action="#">
...
<?php 
	...
	$unq_code = '';
	$status_code = '';
	$qq=mysql_query("SELECT * FROM `c_checkout`  where delivered ='0' and delivery_user = '$user_id' and date = '$now_date' 
	and status='1'  ORDER BY `id` DESC");
	
    $rowsee = mysql_num_rows($qq);
	...
	$unq_code = $row['id_use'];
	$status_code = $row['running_status'];
	?>
     ...
     <tr>
		...
		<td>
		  <div>
  <?php if($status_code=='') {  ?>
<a href="start_processing.php?id=<?php echo $unq_code; ?>">
<span>
<i class="fa fa-car"></i>
Start Processing
</span>
...
<?php } else { ?>
<a href="finish_processing.php?id=<?php echo $unq_code; ?>">
...
<tr>
<td colspan="7">
<center><img src="images/noresult.png"></center>
</td>
</tr>
<?php } ?>
    </tbody>
