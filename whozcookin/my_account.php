   ...
   <div class="section white-text center" id="intro">
        <div class="row">
			...
			<div class="col s12 m9 wow fadeIn content-box" style="color:#000;">
				<h4 class="text-left">PAYMENTS RECORD</h4>
					<hr/>
				<div class="row">
						...
						<table class="bordered">
							<tbody>
								...
								<?php 
								$rr=mysql_query("SELECT * FROM `c_cook_payments` WHERE cook_id = '$user_id' ORDER BY id DESC");
								...
								?>		
								<tr>
								   <th colspan="3" style="font-size:20px !important;">
								  <b> Balance</b>
								    </th>
								    <th colspan="1" style="font-size:20px !important;">
								 	<?php
		
									$user_name1 = mysql_fetch_array(mysql_query("SELECT * FROM `c_cook_sign_up` where id='$user1'"));   ?> 
		
									
									<b><?php echo $user_name1['balance']; ?></b>
								    </th>
								</tr>
